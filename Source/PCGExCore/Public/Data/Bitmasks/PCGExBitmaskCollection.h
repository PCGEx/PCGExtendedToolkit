...
UCLASS(BlueprintType, DisplayName="[PCGEx] Bitmask Library", meta=(ToolTip = "A library of named bitmask values for tagging and adjacency testing.", PCGExNodeLibraryDoc="metadata/bitmasks/bitmask-collection"))

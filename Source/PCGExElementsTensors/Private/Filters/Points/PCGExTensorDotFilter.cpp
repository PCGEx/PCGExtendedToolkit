...
PCGExFactories::EPreparationResult UPCGExTensorDotFilterFactory::Prepare(FPCGExContext* InContext, const TSharedPtr<PCGExMT::FTaskManager>& TaskManager)
{
	...
	if (!PCGExFactories::GetInputFactories(InContext, PCGExTensor::SourceTensorsLabel, TensorFactories, {PCGExFactories::EType::Tensor}, MissingDataPolicy == EPCGExFilterNoDataFallback::Error))
	{

...
UCLASS(Abstract, BlueprintType, ClassGroup = (Procedural), Category="PCGEx|NeighborSample", meta=(PCGExNodeLibraryDoc="sampling/cluster-sample-neighbors/neighbor-sampler", PCGExProxyInterface))

 ...
 */
UCLASS(MinimalAPI, BlueprintType, meta=(DisplayName="Decompose : Max Boxes (Extended)", PCGExNodeLibraryDoc="clusters/analyze/cluster-decomposition/decomp-max-boxes-extended"))

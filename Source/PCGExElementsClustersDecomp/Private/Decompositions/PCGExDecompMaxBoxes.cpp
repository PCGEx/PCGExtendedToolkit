	...
	TArray<int32>& CellVoxelCounts) const
{
	...
	// How many chunks per axis. Ceil as (N-1)/D+1, not (N+D-1)/D: MaxExtent is MAX_int32 on
	// unlimited axes, and the additive form overflows into negative or zero chunk counts.

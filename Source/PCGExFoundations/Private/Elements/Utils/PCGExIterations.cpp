...
TArray<FPCGPinProperties> UPCGExIterationsSettings::OutputPinProperties() const
{
	...
	switch (Type)
	{
	default: case EPCGExIterationDataType::Any:
...
FPCGElementPtr UPCGExIterationsSettings::CreateElement() const
{
	return MakeShared<FPCGExIterationsElement>();
}
...
bool FPCGExIterationsElement::AdvanceWork(FPCGExContext* InContext, const UPCGExSettings* InSettings) const
{
	...
	else
	{
		...
		{
		default: case EPCGExIterationDataType::Params:

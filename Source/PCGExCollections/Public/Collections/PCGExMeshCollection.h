 ...
 */
UCLASS(BlueprintType, DisplayName="[PCGEx] Collection | Mesh", meta=(ToolTip = "A weighted collection of static meshes with optional material overrides.", PCGExNodeLibraryDoc="staging/collections/mesh-collection"))

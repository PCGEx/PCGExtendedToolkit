...
UCLASS(BlueprintType, DisplayName="[PCGEx] Collection | Level", meta=(ToolTip = "A weighted collection of level assets.", PCGExNodeLibraryDoc="staging/collections/level-collection"))

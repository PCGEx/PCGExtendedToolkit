...
public:
	...
	PCGEX_NODE_INFOS_CUSTOM_SUBTITLE(RandomCompareFilterFactory, "Filter : Random (Ratio)", "Passes an exact ratio or count of elements, selected at random.", PCGEX_FACTORY_NAME_PRIORITY)
#endif
	//~End UPCGSettings
